...
- Um único build atual terminou com exit `0`, 26 rotas web e quatro do backoffice, sem warnings. Um único smoke customizado terminou com exit `0` em 2,4 segundos, três probes guest `401` com UUID, dois redirects exatos, 14/11 nonces e banco/Mailpit `0 → 0`, com privacidade e cleanup verdes. Novo HEAD, release, publicação, resposta/resolução, novo review, ready e merge permanecem pendentes; a prova continua local x64 e não substitui o smoke ARM64.
