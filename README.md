...
- FEAT-003 em implementação no [PR #4](https://github.com/PedroRomeroM/set-livre/pull/4), com perfil PF/PJ, `/conta`, segurança e preferência visual integrados localmente; o hardening dos comentários de review e o boundary React-safe passaram na matriz integral, nos builds e nos smokes, enquanto release, commit/push, novo review e merge permanecem pendentes;
