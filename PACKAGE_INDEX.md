...
As threads anteriores foram respondidas e resolvidas. O terceiro P2 `PRRT_kwDOTyzZrs6ZhR_d` já possui gates locais, banco, browser, build e smoke verdes; ainda exige novo HEAD, release, publicação, resposta/resolução e novo review. Não há claim de ready ou merge.
