-- FEAT-008 review hardening: a revision conflict terminalizes its persisted reservation first.
...
comment on function private.reject_studio_media_upload(
  ...
  'Terminaliza uma reserva pela identidade persistida, inclusive quando a revisão foi supersedida; replay preserva o primeiro fato e libera a quota imediatamente.';
