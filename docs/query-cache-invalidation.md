...
- o fence continua provado em concorrência real: uma única tentativa stale, `409`, zero releitura antes da decisão explícita, exatamente um GET autoritativo e nenhum replay. No patch atual, a rodada focada única passou em 23/23, com relatório/stdout/lista SHA-256 `66a4b5ceea14c7affa848748c525adccf684641b377f755a3a9ce3fb05aec6c6`/`ba57e0bd52d165bf422fccc6500eb4fb920c48f785a226baac24e8265c11fe0c`/`ed851b7bca361d0e3e50b5632f12251859b5098a12123a2ee2b8ebbb6f11bf59`; a integral única passou em 114/114, com relatório/stdout/lista SHA-256 `b68c70ff6f17f55142d11394dd9b6113958a7e49ef82d2c5c70324dfcafe6227`/`7b8b7971f91e8a571cec6ac8bb63fed665bbfcd1b9ead4997a6e0436b76114bc`/`322ae32bc132bca0afcd30d4af55d37d4ec31977742e9d721999ab2664e924c6` e cleanup verde;
- o smoke runtime real atual confirmou que as duas APIs privadas de leitura permanecem fechadas ao guest e que `/dono` e `/dono/recebimentos` preservam os dois redirects antes de qualquer hidratação ou cache privado. O run padrão mais FEAT-004 passou com exit `0`, três boundaries, 14/11 nonces, banco `0 → 0` e zero resíduo; resumo SHA-256 `a8d41974344ba6eb3b6cb83d626e4b77e9853a2d98e58814d9c795cca356ad0b` e server log SHA-256 `7ea7719b4af0257044c24c32f252f9327920a069d74b31cac25d3f23d8f089c5`;
