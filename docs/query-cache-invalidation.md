...
- o fence continua provado em concorrência real: uma única tentativa stale, `409`, zero releitura antes da decisão explícita, exatamente um GET autoritativo e nenhum replay. Os hashes 23/23 e 114/114 anteriormente registrados permanecem históricos, mas o P3 possui novas provas próprias: a focada continua verde em 23/23 e a integral corrigida passou em 114/114, preservando os sete IDs da FEAT-004;
- o smoke runtime P3 confirmou em execução única que as duas APIs privadas de leitura e o POST guest permanecem fechados com `401`/UUID e que `/dono` e `/dono/recebimentos` preservam os dois redirects antes de qualquer hidratação ou cache privado. O novo patch também passou em 42/42 unitários focados, 718/718 integrais, typecheck, 358/358 pgTAP e build; a release canônica local final `2a86acc4dc3a005213d5f22384084e3aba0160be` recebeu duas auditorias independentes `NO-BLOCKER`. A captura de `2026-08-15T19:38:32Z` verificou publicação até `dda95b3...`, resposta/resolução e zero threads não resolvidas. Somente commit/push deste registro, eventual ajuste do body e review final ainda estão pendentes;
