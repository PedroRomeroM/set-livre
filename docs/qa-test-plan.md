...
A tentativa recusada do runner e a release `440c81f6...` pertencem ao snapshot histórico anterior; não há release atual até congelar o novo commit Git/HEAD e executar a geração e a auditoria próprias da release.
