...
- após uma operação confirmada ou cancelamento da exclusão, o foco retorna ao controle habilitado
  correspondente antes da próxima interação, sem sobrescrever a escolha posterior do usuário;
