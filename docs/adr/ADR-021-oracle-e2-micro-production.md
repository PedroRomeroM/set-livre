...
- quando ativa, a instância Set Livre consome a segunda e última posição E2 Micro Always Free da tenancy. Em `2026-08-23`, a posição lógica foi revalidada como liberada e sondas repetidas do Plan E2 reportaram falta de capacidade física. Escala horizontal, substituição paralela ou outro host gratuito não podem ser presumidos; qualquer shape pago exige nova decisão humana e evidência de custo;
