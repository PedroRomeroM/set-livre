...
Novo HEAD, release, publicação, resposta/resolução e novo `@codex review` ainda estão pendentes; ready e merge também não foram declarados. O PR e a feature continuam **Em implementação**; toda a prova permanece local x64, e PEND-003/smoke ARM64 nativo continuam obrigatórios para produção.
