...
| SL-F006-E2E-017 | P0         | critical      | 3 engines                  | revogação do dono oculta e apaga criação ainda não salva        | `tests/e2e/critical/feat-006-studio-core-revision.spec.ts`      |
