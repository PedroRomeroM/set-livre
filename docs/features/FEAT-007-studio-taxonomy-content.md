...
- Timestamps de taxonomia e FAQ permanecem monotônicos sob correção regressiva do relógio do host.
...
| SL-F007-E2E-006 | P1         | accessibility | desktop/mobile | conteúdo passa axe, teclado, toque e 320 px            | `tests/e2e/accessibility/feat-007-studio-taxonomy-content.spec.ts` |
| SL-F007-E2E-007 | P2         | reflow        | desktop        | editor comercial preserva reflow em 200%               | `tests/e2e/reflow/feat-007-studio-taxonomy-content.spec.ts`        |
| SL-F007-E2E-008 | P1         | regression    | desktop        | descartar draft restaura o conteúdo publicado          | `tests/e2e/regression/feat-007-studio-taxonomy-content.spec.ts`    |
| SL-F007-E2E-009 | P0         | critical      | desktop        | troca de sessão oculta conteúdo antes da releitura     | `tests/e2e/critical/feat-007-studio-taxonomy-content.spec.ts`      |
| SL-F007-E2E-010 | P1         | regression    | desktop        | retry ambíguo congela formulários e preserva o comando | `tests/e2e/regression/feat-007-studio-taxonomy-content.spec.ts`    |
| SL-F007-E2E-011 | P1         | regression    | desktop        | refetch não ignora conflito nem sobrescreve conteúdo   | `tests/e2e/regression/feat-007-studio-taxonomy-content.spec.ts`    |
