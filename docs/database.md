...
A migration head atual é `20260810000400`. A fundação não antecipa nenhuma tabela de domínio e aplica somente:
...
- 148 asserts pgTAP, incluindo funções-probe que comprovam deny-by-default nos três schemas, ACLs efetivas, o estado exato das roles e a detecção/restauração de grants, ownership, parâmetros, atributos ou memberships adulterados;
