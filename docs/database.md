...
A árvore possui 14 migrations append-only e head `20260812000200`. Reset, geração e `test:db` passaram nesse head; as quatro suítes pgTAP permanecem em 355/355 asserts (`158 + 78 + 57 + 62`). A fundação continua intacta; a FEAT-002 fornece identidade mínima, `legal-core` e recovery, a FEAT-003 completa o perfil e a FEAT-004 acrescenta a autoridade de dono e o recebedor local:
...
- a release local canônica do commit `79376b62bdce788c9eb7e1f1696d5acfde0cb215` empacota exatamente 14 migrations e registra o head `20260812000200`; manifesto e árvore final cobrem as mesmas 2.869 folhas, sem substituir os gerados autoritativos nem significar aplicação remota;
...
- `private.activate_owner(uuid, uuid, uuid, text)`: sob lock do perfil, valida contrato vigente e perfil completo, cria/renova a autoridade e o aceite de forma idempotente e retorna a projeção completa de ativação;
