...
O gerador canônico executou exatamente uma vez para `2045d1a00c15889007b3c5c04c08d0467fc3d9b3`, exit `0` em 21,26 s; o primeiro smoke P5, embutido, ficou verde antes da publicação local do archive. Duas auditorias `NO-BLOCKER` comprovaram live/manifest/tar 2.871 sem mismatch, 3.455 membros seguros e zero cache, secret, env incorporado, PII, incoming/retired, porta, processo, relação DB residual, Mailpit ou dblink. Archive modo `0600` SHA-256 `282f9d173eebf99ba63466d81f4aa4b9061e7d73668c267fb0a25e9e86043b92`; manifesto SHA-256 `d8b698ecef6b6c52f4961e8783ef2c1e68b5ab00239de4de9206cb9f2f2d2026`. A release permanece local/ignorada/não publicada; nenhuma prova x64 substitui ARM64/PEND-003, e remoto segue pendente.
