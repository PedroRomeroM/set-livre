...
A matriz integral atual foi executada uma única vez e passou em 114/114 por 16 projetos, com relatório/stdout/lista SHA-256 `b68c70ff6f17f55142d11394dd9b6113958a7e49ef82d2c5c70324dfcafe6227`/`7b8b7971f91e8a571cec6ac8bb63fed665bbfcd1b9ead4997a6e0436b76114bc`/`322ae32bc132bca0afcd30d4af55d37d4ec31977742e9d721999ab2664e924c6`. A focada atual também foi única e passou em 23/23, com relatório/stdout/lista SHA-256 `66a4b5ceea14c7affa848748c525adccf684641b377f755a3a9ce3fb05aec6c6`/`ba57e0bd52d165bf422fccc6500eb4fb920c48f785a226baac24e8265c11fe0c`/`ed851b7bca361d0e3e50b5632f12251859b5098a12123a2ee2b8ebbb6f11bf59`. As auditorias de privacidade e cleanup ficaram verdes, com zero secrets, PII, resíduo nas 15 relações, Mailpit, dblink, portas, processos ou temporários.

O build atual foi único, exit `0`, sem warnings, log SHA-256 `db0d0049b248dd7b3d438d57ffa0faa465d3cd7a15a9bdd0d6267dc11a4ac162`. O smoke real atual, padrão mais FEAT-004, também passou em uma única execução: resumo SHA-256 `a8d41974344ba6eb3b6cb83d626e4b77e9853a2d98e58814d9c795cca356ad0b`, stdout `e15829cc6525d58cab4fa2ed49c33d9e5d6225512b77ec96a21fa2ea3b9703dba` e server log redigido SHA-256 `7ea7719b4af0257044c24c32f252f9327920a069d74b31cac25d3f23d8f089c5`. Os três boundaries, dois redirects, 14/11 nonces e banco `0 → 0` passaram; Mailpit, portas, processos, temporários, secrets e PII terminaram em zero. A primeira tentativa do runner temporário falhou antes de spawn por consultar `profile_preferences` em vez de `user_preferences`; log SHA-256 `9757fbc1baf5afcffc4840468f7f7af5c7c1677a924997184376617b8752e2db`, sem servidor, request ou temporário residual. A correção foi somente no harness antes da única execução real verde.
...
Na release canônica local atual, o gerador foi invocado uma única vez para o commit `440c81f6cc44cc95ed281d84e9a5124ae98a59c4` e terminou com exit `0`; log SHA-256 `be9e2e2d0d1d2a4db78593c03858c183f93b3ed336bd820d3ce9d64c08ec1ba4`. Tar, sidecar, smoke canônico embutido, guardas de segurança, buscas de secrets e PII e cleanup ficaram verdes em toda a árvore manifestada de 2.869 folhas. A release contém o patch e foi registrada pelo commit documental publicado `011a48f4910baa0e17b26dee6eda3c678d910572`; a thread do P2 foi respondida e resolvida depois da verificação. Isso não atribui checks remotos ao delta. A prova é local Linux x64 e não substitui PEND-003 nem o smoke ARM64 nativo; `79376b62...` permanece histórico.
