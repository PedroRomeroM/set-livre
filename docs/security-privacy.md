...
Na release local histórica daquela fotografia, o gerador foi invocado uma única vez para o commit `79376b62bdce788c9eb7e1f1696d5acfde0cb215` e terminou com exit `0`; log SHA-256 `1e8f5bf3d472f2000d8b32d53b0dca2165ec72513f79f407800e4d8d9d56afba`. O smoke canônico embutido, as guardas de segurança, as buscas de secrets e PII e o cleanup ficaram verdes em toda a árvore manifestada de 2.869 folhas. Essa release não contém o patch atual; nova release canônica e publicação permanecem pendentes. A prova é local Linux x64 e não substitui PEND-003 nem o smoke ARM64 nativo.
