...
A release `c115dcd726929f289777cd897cccc97d33a179ee` permanece histórica e antecede os dois P2 do PR #6. Banco 355/355, gates Node 24, matriz focada 23/23, integral 114/114, build e smoke estão verdes com evidência pós-review aceita; somente o empacotamento por novo SHA ainda é obrigatório antes de substituir a fotografia publicada. Até lá, a release de 13 migrations permanece stale em relação ao código local e não deve ser promovida.
