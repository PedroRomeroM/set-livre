...
A release local canônica atual foi gerada uma única vez para o commit `79376b62bdce788c9eb7e1f1696d5acfde0cb215`, com exit `0` e log SHA-256 `1e8f5bf3d472f2000d8b32d53b0dca2165ec72513f79f407800e4d8d9d56afba`. O archive `.artifacts/set-livre-79376b62bdce788c9eb7e1f1696d5acfde0cb215.tar.gz` possui 24.902.933 bytes, SHA-256 `af39e5d2f8f6d919e2adc554e27e214fa170dac12a7285ca8ec9630a7d1f8a1c` e sidecar SHA-256 `0c6bade3db133ccec9a01695a1cd7003d86d0e4275a739f389e3b63a78add5f5`. O manifesto possui 681.311 bytes e SHA-256 `c6514c43d37b8e687731fa2d8788da52df8df53acec11a640aa7707f4cb1d584`. São 3.453 membros no tar — 584 diretórios, 2.867 arquivos e dois links — e 2.869 folhas na release: web 1.577, backoffice 1.276, migrations 14, lockfile 1 e manifesto 1. Os `BUILD_ID` equivalem ao commit e o head é `20260812000200`, em Linux x64 com Node 24.18/npm 11.19; smoke embutido, segurança, buscas de secrets/PII e cleanup ficaram verdes.

A release `c115dcd726929f289777cd897cccc97d33a179ee`, com 13 migrations, permanece histórica, stale e anterior aos dois P2 do PR #6. A nova release ainda é local: publicação do novo HEAD continua pendente, e nenhuma das duas fotografias comprova ARM64 ou produção. PEND-003 e o smoke ARM64 nativo permanecem obrigatórios.

O smoke runtime final autorizado terminou com exit `0`; log SHA-256 `85db0dad1e7cbd999e4427222fdd1b685a3747ffde154eb5a46b444e9cf8f735` e server log redigido `4da1f9af3e0bb34285be99be0ef71d4cefa22108bbe817c23c4c8983828755bf`. O contrato release-equivalent passou integralmente, com 14 nonces web e 11 backoffice únicos. Os boundaries guest FEAT-004 retornaram `401` com UUID para os dois GETs e para o POST sintético de Host/Origin exatos sem cookie; as rotas do dono emitiram redirects streaming exatos. As 15 relações ficaram `0 → 0`; dois secrets canônicos, PIDs, portas e temporários terminaram em zero.
