...
Concluir os dois P2 do [PR #6](https://github.com/PedroRomeroM/set-livre/pull/6): gates, banco, browser, build, smoke, release canônica e publicação do novo HEAD já estão concluídos. Agora faltam resposta/resolução das duas threads e novo review antes de promover para ready e fazer merge. A release `c115dcd...` permanece apenas como fotografia histórica anterior ao review; a atual continua vinculada ao commit funcional publicado `79376b62...`. PEND-003 e o smoke ARM64 nativo continuam bloqueando produção. Mudanças de sequência exigem atualização do ADR-017, da ordem especializada e da rastreabilidade.
