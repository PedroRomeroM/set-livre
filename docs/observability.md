...
O gerador da release local do commit `79376b62bdce788c9eb7e1f1696d5acfde0cb215` terminou com exit `0` em uma única invocação; log SHA-256 `1e8f5bf3d472f2000d8b32d53b0dca2165ec72513f79f407800e4d8d9d56afba`. O smoke embutido e as varreduras de segurança, secrets e PII ficaram verdes, e o cleanup terminou sem resíduo. Esse registro é histórico para o patch local, Linux x64 e não telemetria de ARM64 ou produção.
